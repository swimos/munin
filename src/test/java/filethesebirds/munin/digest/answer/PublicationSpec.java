...
public class PublicationSpec {
  ...
  public void testAnswerFromPublication() {
    ...
    final Answer result = Publication.answerFromPublication(TAXONOMY, body);
  ...
  public void testPublicationFromAnswer() {
    ...
    final MutableAnswer derived = (MutableAnswer) Publication.answerFromPublication(TAXONOMY, Publication.publicationFromAnswer(TAXONOMY, answer));
