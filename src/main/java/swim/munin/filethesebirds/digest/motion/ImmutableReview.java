    ...
    public Review cast(Item item) {
      ...
      try {
        ...
        if (tag().equals(tag)) {
          ...
          final Set<String> overrideSet = swim.munin.filethesebirds.digest.Forms.forSetString().cast(overrideItem);
          ...
          final Set<String> plusSet = Forms.forSetString().cast(plusItem);
